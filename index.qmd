...
<section class="hero">
  <div class="hero-inner">
    <div class="hero-eyebrow">Analytics Engineer &amp; Data Scientist · Nairobi, Kenya</div>
    <h1 class="hero-name">Agu Charles<br><span>Chibuike</span></h1>
    <p class="hero-title">
      I design ETL pipelines, warehousing solutions, and BI dashboards across
      IoT, EV infrastructure, and hospitality — with <strong>5+ years</strong>
      raising data accuracy from 78% to 94%+ and cutting reporting cycle
      times by over 60% through SQL and Python automation.
    </p>
    <div class="hero-badges">
      <span class="badge badge-teal">SQL &amp; PostgreSQL</span>
      <span class="badge badge-teal">Snowflake / dbt</span>
      <span class="badge badge-teal">Power BI</span>
      <span class="badge badge-outline">R &amp; Shiny</span>
      <span class="badge badge-outline">Time Series &amp; ML</span>
    </div>
    <div class="hero-ctas">
  ...
  <div class="section" id="projects">
    ...
    <div class="project-grid">
      ...
      <a class="project-card" href="https://agucharles.shinyapps.io/nairobi-runners/" target="_blank" rel="noopener noreferrer">
        <div class="project-number">02 / INTERACTIVE</div>
      ...
      <a class="project-card" href="https://github.com/agucharles91-cpu/Olist-Ecommerce-Analytics" target="_blank" rel="noopener noreferrer">
        ...
        <div class="project-desc">
          ...
          advanced SQL, cohort analysis, and an executive Power BI dashboard.
        </div>
        <div class="project-tags">
      ...
      <a class="project-card" href="https://github.com/agucharles91-cpu/Parking-Enforcement-Analytics" target="_blank" rel="noopener noreferrer">
        <div class="project-number">04 / ANALYTICS ENGINEERING</div>
        ...
        <div class="project-desc">
          ...
          Python ingestion, anonymisation, Parquet data engineering, DuckDB, dbt
          transformations, time-series analysis, and Power BI reporting.
        </div>
        <div class="project-tags">
...
<div class="contact-bg">
  <div class="section" id="contact">
    ...
    <div class="contact-links contact-links-full">
      ...
      <div class="contact-link-row"><span class="contact-icon">◈</span> <a href="https://linkedin.com/in/agucharles" target="_blank" rel="noopener noreferrer">linkedin.com/in/agucharles</a></div>
