...
<section class="hero">
  <div class="hero-inner">
    ...
    <p class="hero-title">
      I build reliable analytical workflows that turn
      <strong>raw operational data into validated models,
      decision-ready dashboards, and actionable insights</strong> —
      using SQL, PostgreSQL, Python, R, dbt and Power BI.
    </p>

    <p class="hero-context">
      MSc Data Science candidate · University of Nairobi
    </p>
